...
TODO:
- Написать свой HybridAlohaDriver, единый фасад appium+playwright. Вообще объеденить адаптеры+драйверы+конфиги в единый alohadriver. В отдельный репозиторий с своими юнит/интегр тестами на драйвер. 
